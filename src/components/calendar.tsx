  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute bg-background text-foreground inset-0 opacity-0",
        ...
        range_start: cn(
          "rounded-(--cell-radius) bg-primary relative not-last:after:bg-primary/50 after:rounded-l-(--cell-radius) after:absolute after:inset-y-0 after:w-4 after:right-0 z-10 isolate",
          defaultClassNames.range_start,
        ),
        range_middle: cn("rounded-none z-0", defaultClassNames.range_middle),
        range_end: cn(
          "rounded-(--cell-radius) bg-primary relative not-first:after:bg-primary/50 after:rounded-r-(--cell-radius) after:absolute after:inset-y-0 after:w-4 after:left-0 z-10 isolate",
