              ...
              >
                ...
                >
                  <BaseUIDrawer.Content
                    className={cnBaseUI(
                      "mx-auto flex w-full flex-col gap-4 py-8",
                      contentClassName,
                    )}
                    {...contentProps}
                  >
